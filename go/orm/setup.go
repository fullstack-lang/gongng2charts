...
func SetupModels(logMode bool, filepath string) *gorm.DB {
	...
	gormConfig := &gorm.Config{
		NamingStrategy: schema.NamingStrategy{
			TablePrefix: "github_com_fullstack_lang_gongng2charts_go_", // table name prefix
		},
	}
...
func AutoMigrate(db *gorm.DB) {
	...
	if err != nil {
		msg := err.Error()
		panic("problem with migration " + msg + " on package github.com/fullstack-lang/gongng2charts/go")
	}
	// log.Printf("Database Migration of package github.com/fullstack-lang/gongng2charts/go is OK")
...
func ResetDB(db *gorm.DB) { // insertion point for reference to structs
	db.Delete(&ChartDB{})
	db.Delete(&ChartConfigurationDB{})
	db.Delete(&DataPointDB{})
	db.Delete(&DatasetDB{})
	db.Delete(&LabelDB{})
}